...
DEFINE WINDOW a1 FROM 03, 00 TO  ;
       ...
       SCHEME 5
ACTIVATE WINDOW a1
xd = 'Constancia de Buena Conducta'
@ 0, 0 SAY SPACE(((WCOLS() -  ;
  LEN(xd) - 6) / 2) + 3) + xd
ng = CHR(27) + CHR(69)
ngn = CHR(27) + CHR(70)
...
DO WHILE .T.
     ...
     @ 04, 00 SAY SPACE(((80 -  ;
       LEN(y4) - 6) / 2) + 3) +  ;
       y4
     centro1 = 'C O N S T A N C I A  D E  B U E N A  C O N D U C T A'
     @ 11, 00 SAY SPACE(((80 -  ;
       LEN(centro1) - 6) / 2) +  ;
       3) + centro1
     @ 18, 05 SAY  ;
     ...
     @ 22, 05 SAY xnombre
     @ 24, 05 SAY  ;
       'de Identidad Nro.____________, curs¢ estudios en esta instituci¢n en el'
     @ 24, 23 SAY xcedula PICTURE  ;
       '!-9999999999'
     @ 26, 05 SAY  ;
       'el plan de estudio de la Modalidad Educaci¢n de Adultos,  y  durante su'
     @ 28, 05 SAY  ;
       'permanencia en el mismo OBSERVO BUENA CONDUCTA EN EL SOLICITANTE.'
     @ 32, 05 SAY  ;
