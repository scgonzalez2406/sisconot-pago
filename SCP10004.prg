...
IF  .NOT. WEXIST('_r7a0vjj0c')
     DEFINE WINDOW _r7a0vjj0c  ;
            ...
            SHADOW TITLE  ;
            'Actualizaci¢n de Bancos Comericales'  ;
...
@ 04, 02 SAY 'Nombre del Banco: '  ;
  COLOR SCHEME 5 GET m.descripcio  ;
  SIZE 1, 26, 2 PICTURE '@!' WHEN  ;
  isediting
@ 06, 02 SAY 'Tipo de Cuenta: '  ;
  COLOR SCHEME 5 GET m.tipocuenta  ;
  SIZE 1, 12, 2 PICTURE  ;
  '@!M Corriente,Ahorro' WHEN  ;
  isediting
@ 08, 02 SAY 'N£mero de Cuenta: '  ;
  COLOR SCHEME 5 GET m.nrocuenta  ;
  SIZE 1, 30, 2 PICTURE '@!' WHEN  ;
  isediting
@ 09, 0 SAY 'Ã' + REPLICATE('Ä',  ;
  WCOLS() - 2) + '´'
@ 10, 2 GET m.top_btn DEFAULT 1  ;
  SIZE 1, 10, 2 PICTURE  ;
  '@*HN \<Primero   ' VALID  ;
  btn_val('TOP') MESSAGE  ;
  'Ir al Comienzo de Archivo.'  ;
  COLOR SCHEME 5
@ 10, 17 GET m.prev_btn DEFAULT 1  ;
  SIZE 1, 10, 2 PICTURE  ;
  '@*HN \<Anterior  ' VALID  ;
  btn_val('PREV') MESSAGE  ;
  'Ir al registro anterior' COLOR  ;
  SCHEME 5
@ 10, 32 GET m.next_btn DEFAULT 1  ;
  SIZE 1, 10, 2 PICTURE  ;
  '@*HN \<Siguiente ' VALID  ;
  btn_val('NEXT') MESSAGE  ;
  'Ir al registro siguiente'  ;
  COLOR SCHEME 5
@ 10, 47 GET m.end_btn DEFAULT 1  ;
  SIZE 1, 10, 2 PICTURE  ;
  '@*HN \<Final     ' VALID  ;
  btn_val('END') MESSAGE  ;
  'Ir al final del Archivo' COLOR  ;
  SCHEME 5
@ 10, 62 GET m.loc_btn DEFAULT 1  ;
  SIZE 1, 10, 2 PICTURE  ;
  '@*HN \<Buscar    ' VALID  ;
  btn_val('LOCATE') MESSAGE  ;
  'Buscar Registros' COLOR SCHEME  ;
  5
@ 11, 02 GET m.add_btn DEFAULT 1  ;
  SIZE 1, 10, 2 PICTURE  ;
  '@*HN \<Nuevo     ' VALID  ;
  btn_val('ADD') MESSAGE  ;
  'Ingresar un nuevo registro'  ;
  COLOR SCHEME 5
@ 11, 17 GET m.edit_btn DEFAULT 1  ;
  SIZE 1, 10, 2 PICTURE  ;
  '@*HN \<Modificar ' VALID  ;
  btn_val('EDIT') MESSAGE  ;
  'Modifica el Presente Registro.'  ;
  COLOR SCHEME 5
@ 11, 32 GET m.del_btn DEFAULT 1  ;
  SIZE 1, 10, 2 PICTURE  ;
  '@*HN \<Eliminar  ' VALID  ;
  btn_val('DELETE') MESSAGE  ;
  'Elimina el Registro Actual'  ;
  COLOR SCHEME 5
@ 11, 47 GET m.prnt_btn DEFAULT 1  ;
  SIZE 1, 10, 2 PICTURE  ;
  '@*HN \<Imprimir  ' VALID  ;
  btn_val('PRINT') MESSAGE  ;
  'Registro de Impresi¢n.' COLOR  ;
  SCHEME 5
@ 11, 62 GET m.exit_btn DEFAULT 1  ;
  SIZE 1, 10, 2 PICTURE  ;
  '@*HN Sa\<lir     ' VALID  ;
  btn_val('EXIT') MESSAGE  ;
  'Finaliza la Actualizaci¢n de Bancos Comerciales.'  ;
  COLOR SCHEME 5
     ...
     CASE m.btnname = 'EDIT'  ;
          ...
          ELSE
               IF EMPTY(m.descripcio)
                    = msgerro( ;
                      'El Nombre del Banco Comercial en Blanco' ;
                      )
...
DO CASE
     ...
     CASE m.paction = 'SAVE'
          ...
          IF FOUND()
               p = msgerro( ;
                   'Este Banco Comercial ya fue registrado' ;
                   )
               _CUROBJ = OBJNUM(m.codigo)
               RETURN .F.
          ENDIF
