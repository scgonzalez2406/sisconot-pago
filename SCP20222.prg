...
DEFINE WINDOW record1 FROM 01, 00  ;
       TO 25, 79 FLOAT NOCLOSE  ;
       SHADOW TITLE  ;
       'Registro Inscripciขn Materias Adicionales (SCP20222)'  ;
...
DO WHILE .T.
     ...
     IF FOUND()
          p11 = 1
          = msgerro( ;
            'El Alumno ya esta inscrito en Matricula de Materias Adicionales' ;
            )
          p = acepta( ;
     ...
     IF  .NOT. SEEK(m.cedula)
          DEFINE WINDOW reg FROM  ;
                 ...
                 ZOOM SHADOW  ;
                 TITLE  ;
                 'Registro de Control de Pago Materia Adicional'  ;
                 MINIMIZE SYSTEM  ;
                 COLOR SCHEME 5
                         ...
                         DO WHILE  ;
                            .T.
                              IF FLOCK()
                                   ...
                                   REPLACE nrocuota WITH ii, transa WITH 'BD'
