...
DEFINE WINDOW sclr FROM 09, 10 TO  ;
       20, 70 FLOAT NOCLOSE  ;
       SHADOW TITLE  ;
       'Relaciขn de Cancelaciขn  (SCP30066)'  ;
...
titulo3 = 'LISTADOS DE ALUMNOS POR SEMESTRE CON MENSUALIDAD AL DIA'
SAVE SCREEN TO jol
...
DO WHILE  .NOT. EOF()
     IF li > 58
          ...
          @ 05, 00 SAY SPACE(((80 -  ;
            LEN(titulo3) - 6) /  ;
            2) + 3) + titulo3
          titulo4 = 'EN EL PERIODO COMPRENDIDO ENTRE: ' +  ;
                    DTOC(m.fecha1) +  ;
                    ' Y: ' +  ;
                    DTOC(m.fecha2)
          @ 06, 00 SAY SPACE(((80 -  ;
            ...
            2) + 3) + titulo4
          @ 07, 00 SAY  ;
            'ีออออัออออออออออัออออออออออออออออออออออออออออออออออออออออออออธ'
          @ 08, 00 SAY  ;
            'ณNro.ณ CEDULA   ณ APELLIDOS Y NOMBRES                        ณ'
          @ 09, 00 SAY  ;
            'ฦออออุออออออออออุออออออออออออออออออออออออออออออออออออออออออออต'
          li = 10
     ENDIF
     m.ced = cedula
     SELECT 2
...
li = li + 1
@ li, 00 SAY  ;
  'ิออออฯออออออออออฯออออออออออออออออออออออออออออออออออออออออออออพ'
li = li + 1
@ li, 01 SAY  ;
  'Total Alumnos Al Dia en el Periodo: '
